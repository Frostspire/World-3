...
public enum Arrow implements Fletchable {
	...
	IRON_ARROWS(new Item(53, 15), new Item(40, 15), new FletchableItem(new Item(884, 15), 15, 37)),
	STEEL_ARROWS(new Item(53, 15), new Item(41, 15), new FletchableItem(new Item(886, 15), 30, 7)),
	MITHRIL_ARROWS(new Item(53, 15), new Item(42, 15), new FletchableItem(new Item(888, 15), 45, 112)),
	ADAMANT_ARROWS(new Item(53, 15), new Item(43, 15), new FletchableItem(new Item(890, 15), 60, 150)),
	RUNE_ARROWS(new Item(53, 15), new Item(44, 15), new FletchableItem(new Item(892, 15), 75, 187)),
	DRAGON_ARROWS(new Item(53, 15), new Item(11237, 15), new FletchableItem(new Item(11212, 15), 90, 225));
