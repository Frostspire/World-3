...
public enum Crossbow implements Fletchable {
	BRONZE_CROSSBOW(new Item(9440), new Item(9420), new FletchableItem(new Item(9454), 9, 12)),
	IRON_CROSSBOW(new Item(9444), new Item(9423), new FletchableItem(new Item(9457), 39, 44)),
	STEEL_CROSSBOW(new Item(9446), new Item(9425), new FletchableItem(new Item(9459), 46, 54)),
	MITHRIL_CROSSBOW(new Item(9448), new Item(9427), new FletchableItem(new Item(9461), 54, 64)),
	ADAMANT_CROSSBOW(new Item(9450), new Item(9429), new FletchableItem(new Item(9463), 61, 82)),
	RUNE_CROSSBOW(new Item(9452), new Item(9431), new FletchableItem(new Item(9465), 69, 100));
