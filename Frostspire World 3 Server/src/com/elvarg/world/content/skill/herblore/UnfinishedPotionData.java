...
public enum UnfinishedPotionData {
	...
	public static UnfinishedPotionData getPotion(Item item) {
		for(UnfinishedPotionData potion : UnfinishedPotionData.values()) {
			if(potion.getIngredient().getId() == item.getId()) {
				return potion;
			}
		}
		return null;
