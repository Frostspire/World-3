package com.elvarg.world.content.skill.herblore;
...
public enum FinishedPotionData {
	...
	public static FinishedPotionData getPotion(Item item) {
		for(FinishedPotionData potion : FinishedPotionData.values()) {
			if(potion.getUnfinishedPotion().getId() == item.getId()) {
				return potion;
			}
		}
		return null;
