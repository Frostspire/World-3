...
import com.frostspire.world.content.skill.fishing.Fishing;
import com.frostspire.world.entity.combat.magic.CombatSpell;
import com.frostspire.world.entity.combat.magic.CombatSpells;
...
public class NPCOptionPacketListener implements PacketListener {
	...
	public static boolean handlers(Player player, NPC npc, int option) {
		if(Fishing.setupFishing(player,  npc, option)) {
			return true;
		}
		return false;
	}
