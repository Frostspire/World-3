...
import com.frostspire.world.model.syntax.impl.BankX;
import com.frostspire.world.model.syntax.impl.BuyX;
import com.frostspire.world.model.syntax.impl.PriceCheckX;
import com.frostspire.world.model.syntax.impl.SellX;
import com.frostspire.world.model.syntax.impl.TradeX;
import com.frostspire.world.model.syntax.impl.WithdrawBankX;
...
public class ItemContainerActionPacketListener implements PacketListener {
	...
	private static void firstAction(Player player, Packet packet) {
		...
		case Smithing.SMITHING_INTERFACE_ROW_1:
		case Smithing.SMITHING_INTERFACE_ROW_2:
		case Smithing.SMITHING_INTERFACE_ROW_3:
		case Smithing.SMITHING_INTERFACE_ROW_4:
		case Smithing.SMITHING_INTERFACE_ROW_5:
			Smithing.handleItemClick(player, id, 1);
			break;
			
		case Jewelry.JEWELRY_INTERFACE_ROW_1:
		case Jewelry.JEWELRY_INTERFACE_ROW_2:
		case Jewelry.JEWELRY_INTERFACE_ROW_3:
			Jewelry.handleItemClick(player, id, 1);
			break;
	...
	private static void secondAction(Player player, Packet packet) {
		...
		case Smithing.SMITHING_INTERFACE_ROW_4:
		case Smithing.SMITHING_INTERFACE_ROW_5:
			Smithing.handleItemClick(player, id, 5);
			break;
			
		case Jewelry.JEWELRY_INTERFACE_ROW_1:
		case Jewelry.JEWELRY_INTERFACE_ROW_2:
		case Jewelry.JEWELRY_INTERFACE_ROW_3:
			Jewelry.handleItemClick(player, id, 5);
			break;
	...
	private static void thirdAction(Player player, Packet packet) {
		...
		case Smithing.SMITHING_INTERFACE_ROW_4:
		case Smithing.SMITHING_INTERFACE_ROW_5:
			Smithing.handleItemClick(player, id, 10);
			break;
			
		case Jewelry.JEWELRY_INTERFACE_ROW_1:
		case Jewelry.JEWELRY_INTERFACE_ROW_2:
		case Jewelry.JEWELRY_INTERFACE_ROW_3:
			Jewelry.handleItemClick(player, id, 10);
			break;
