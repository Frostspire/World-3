package com.frostspire.world.collision.region;

import java.util.ArrayList;

import com.frostspire.GameLoader;
import com.frostspire.cache.impl.CacheArchive;
import com.frostspire.cache.impl.CacheConstants;
import com.frostspire.cache.impl.definitions.ObjectDefinition;
import com.frostspire.world.collision.buffer.ByteStreamExt;
...
public final class RegionClipping {
	...
	public static void init() {
		try {
			...
			CacheArchive archive = GameLoader.getCache().getArchive(CacheConstants.MANIFEST_ARCHIVE);
	...
	public static void loadRegion(int x, int y) {
		...
		try {
			...
			byte[] objectData = GameLoader.getCache().getDecompressedFile(CacheConstants.MAP_INDEX, 
					r.regionData.objectFile);
			byte[] terrainData = GameLoader.getCache().getDecompressedFile(CacheConstants.MAP_INDEX, 
