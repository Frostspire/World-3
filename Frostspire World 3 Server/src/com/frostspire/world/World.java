...
import com.frostspire.world.entity.impl.CharacterList;
...
import com.frostspire.world.entity.updating.NpcUpdateSequence;
import com.frostspire.world.entity.updating.PlayerUpdateSequence;
import com.frostspire.world.entity.updating.UpdateSequence;
...
public class World {
	...
	public static void sequence() {
		...
		while ($it.hasNext()) {
			...
			boolean force_logout = GameLoader.isUpdating() || 
