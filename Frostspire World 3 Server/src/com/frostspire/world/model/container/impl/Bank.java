package com.frostspire.world.model.container.impl;
...
import com.frostspire.world.model.container.ItemContainer;
import com.frostspire.world.model.container.StackType;
import com.frostspire.world.model.equipment.BonusManager;
import com.frostspire.world.model.syntax.impl.SearchBank;
...
public class Bank extends ItemContainer {
	...
	public Bank refreshItems() {
		...
		if(getPlayer().isSearchingBank()) {
			...
			getPlayer().getPacketSender().sendString(5383, "Bank of Frostspire")
			.sendConfig(117, 0);
		}
