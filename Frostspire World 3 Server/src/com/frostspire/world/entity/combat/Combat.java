...
import com.frostspire.world.entity.combat.hit.HitDamageCache;
import com.frostspire.world.entity.combat.hit.HitQueue;
...
import com.frostspire.world.entity.combat.ranged.RangedData.AmmunitionData;
...
import com.frostspire.world.model.DamageDealer;
				...
				if(attackTimer <= 0 || disregardDelay) {
					...
					if(CombatFactory.canAttack(character, method, target)) {
						...
						for(QueueableHit hit : hits) {
							CombatFactory.addHitToQueue(hit);
						}
