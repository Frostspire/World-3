package com.frostspire.world.entity.combat.ranged;
...
public class RangedData {
	...
	public enum AmmunitionData {
		...
		BRONZE_DART(806, new Graphic(232, GraphicHeight.HIGH), 226, 2),
		IRON_DART(807, new Graphic(233, GraphicHeight.HIGH), 227, 5),
		STEEL_DART(808, new Graphic(234, GraphicHeight.HIGH), 228, 8),
		MITHRIL_DART(809, new Graphic(235, GraphicHeight.HIGH), 229, 10),
		ADAMANT_DART(810, new Graphic(236, GraphicHeight.HIGH), 230, 15),
		RUNE_DART(811, new Graphic(237, GraphicHeight.HIGH), 231, 20),
		DRAGON_DART(11230, new Graphic(1123, GraphicHeight.HIGH), 226, 25),

		BRONZE_KNIFE(864, new Graphic(219, GraphicHeight.HIGH), 212, 8),
		BRONZE_KNIFE_P1(870, new Graphic(219, GraphicHeight.HIGH), 212, 8),
		BRONZE_KNIFE_P2(5654, new Graphic(219, GraphicHeight.HIGH), 212, 8),
		BRONZE_KNIFE_P3(5661, new Graphic(219, GraphicHeight.HIGH), 212, 8),

		IRON_KNIFE(863, new Graphic(220, GraphicHeight.HIGH), 213, 12),
		IRON_KNIFE_P1(871, new Graphic(220, GraphicHeight.HIGH), 213, 12),
		IRON_KNIFE_P2(5655, new Graphic(220, GraphicHeight.HIGH), 213, 12),
		IRON_KNIFE_P3(5662, new Graphic(220, GraphicHeight.HIGH), 213, 12),

		STEEL_KNIFE(865, new Graphic(221, GraphicHeight.HIGH), 214, 15),
		STEEL_KNIFE_P1(872, new Graphic(221, GraphicHeight.HIGH), 214, 15),
		STEEL_KNIFE_P2(5656, new Graphic(221, GraphicHeight.HIGH), 214, 15),
		STEEL_KNIFE_P3(5663, new Graphic(221, GraphicHeight.HIGH), 214, 15),

		BLACK_KNIFE(869, new Graphic(222, GraphicHeight.HIGH), 215, 17),
		BLACK_KNIFE_P1(874, new Graphic(222, GraphicHeight.HIGH), 215, 17),
		BLACK_KNIFE_P2(5658, new Graphic(222, GraphicHeight.HIGH), 215, 17),
		BLACK_KNIFE_P3(5665, new Graphic(222, GraphicHeight.HIGH), 215, 17),

		MITHRIL_KNIFE(866, new Graphic(223, GraphicHeight.HIGH), 215, 19),
		MITHRIL_KNIFE_P1(873, new Graphic(223, GraphicHeight.HIGH), 215, 19),
		MITHRIL_KNIFE_P2(5657, new Graphic(223, GraphicHeight.HIGH), 215, 19),
		MITHRIL_KNIFE_P3(5664, new Graphic(223, GraphicHeight.HIGH), 215, 19),

		ADAMANT_KNIFE(867, new Graphic(224, GraphicHeight.HIGH), 217, 24),
		ADAMANT_KNIFE_P1(875, new Graphic(224, GraphicHeight.HIGH), 217, 24),
		ADAMANT_KNIFE_P2(5659, new Graphic(224, GraphicHeight.HIGH), 217, 24),
		ADAMANT_KNIFE_P3(5666, new Graphic(224, GraphicHeight.HIGH), 217, 24),

		RUNE_KNIFE(868, new Graphic(225, GraphicHeight.HIGH), 218, 30),
		RUNE_KNIFE_P1(876, new Graphic(225, GraphicHeight.HIGH), 218, 30),
		RUNE_KNIFE_P2(5660, new Graphic(225, GraphicHeight.HIGH), 218, 30),
		RUNE_KNIFE_P3(5667, new Graphic(225, GraphicHeight.HIGH), 218, 30),
		...
		public static AmmunitionData getFor(Player p) {
			...
			AmmunitionData throwWeapon = range_ammo_data.get(p.getEquipment().getItems()[Equipment.WEAPON_SLOT].getId());
