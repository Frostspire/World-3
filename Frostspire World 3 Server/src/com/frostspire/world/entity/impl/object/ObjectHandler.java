package com.frostspire.world.entity.impl.object;
...
public class ObjectHandler {
	...
	/**
	 * Returns whether an object exists at a position.
	 * @param pos
	 * @return boolean
	 */
	...
	/**
	 * Spawns Retrieves an object at a specified position
	 * @param pos
	 * @return GameObject
	 */
	public static GameObject getGameObject(Position pos) {
		for(GameObject obj : objects) {
			if(obj != null && obj.getPosition().equals(pos)) {
				return obj;
			}
		}
		return null;
