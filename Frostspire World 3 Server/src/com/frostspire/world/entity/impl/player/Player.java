...
package com.frostspire.world.entity.impl.player;
...
import com.frostspire.engine.task.impl.CombatPoisonEffect;
import com.frostspire.engine.task.impl.OverloadPotionTask;
import com.frostspire.engine.task.impl.PlayerDeathTask;
import com.frostspire.engine.task.impl.PlayerSpecialAmountTask;
import com.frostspire.engine.task.impl.WalkToTask;
import com.frostspire.net.PlayerSession;
import com.frostspire.net.SessionState;
import com.frostspire.net.packet.PacketSender;
import com.frostspire.util.FrameUpdater;
import com.frostspire.util.Stopwatch;
import com.frostspire.world.World;
import com.frostspire.world.content.ServerFeed;
import com.frostspire.world.content.Trading;
import com.frostspire.world.content.clan.ClanChat;
import com.frostspire.world.content.clan.ClanChatManager;
import com.frostspire.world.content.skill.Skill;
import com.frostspire.world.content.skill.SkillManager;
...
import com.frostspire.world.entity.combat.pvp.BountyHunter;
...
import com.frostspire.world.entity.impl.npc.NpcAggression;
import com.frostspire.world.model.Animation;
import com.frostspire.world.model.Appearance;
import com.frostspire.world.model.ChatMessage;
import com.frostspire.world.model.EffectTimer;
...
import com.frostspire.world.model.Locations;
import com.frostspire.world.model.MagicSpellbook;
import com.frostspire.world.model.PlayerInteractingOption;
import com.frostspire.world.model.PlayerRelations;
...
import com.frostspire.world.model.container.impl.Inventory;
import com.frostspire.world.model.container.impl.PriceChecker;
import com.frostspire.world.model.container.impl.Shop;
import com.frostspire.world.model.dialogue.Dialogue;
import com.frostspire.world.model.dialogue.DialogueOptions;
import com.frostspire.world.model.equipment.BonusManager;
import com.frostspire.world.model.movement.MovementStatus;
...
public class Player extends Character {
	...
	public boolean canLogout() {
		if (CombatFactory.isBeingAttacked(this) || CombatFactory.isAttacking(this)) {
	...
	public void onLogout() {
		...
		//update friends list
		getRelations().setStatus(PrivateChatStatus.OFF, true);
	...
	private String clanChatName = "Chosenblades";
	...
	private Task currentSkillingTask;
	...
	//Skills
	private Fletchable fletchingItem = null;
	private Item skillingItem = null;
	...
	public Task getCurrentSkillingTask() {
		return currentSkillingTask;
	}
	
	public void setCurrentSkillingTask(Task task) {
		this.currentSkillingTask = task;
		TaskManager.submit(task);
	}
	
	public void resetCurrentSkillingTask() {
		this.currentSkillingTask = null;
	}
	...
	public Fletchable getFletchingItem() {
		return fletchingItem;
	}
	
	public void setFletchingItem(Fletchable item) {
		this.fletchingItem = item;
	}
	
	public Item getSkillingItem() {
		return skillingItem;
	}
	
	public void setSkillingItem(Item item) {
		this.skillingItem = item;
	}
}
